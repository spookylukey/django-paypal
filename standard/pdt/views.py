...
def pdt(request, item_check_callable=None):
    ...
    if txn_id is not None:
        ...
        # ### This is a super long except clause, could we set pdt_obj = None
        # ### and the top and test for is None and move this out of the except?
        ...
        pass
    # ### Is this a `failed PDT`? should we create an object and set_flag w/ no txn_id?
    # 
