    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "firstname",
                    models.CharField(max_length=255, verbose_name="First Name", blank=True),
                ),
                (
                    "lastname",
                    models.CharField(max_length=255, verbose_name="Last Name", blank=True),
                ),
                (
                    "street",
                    models.CharField(max_length=255, verbose_name="Street Address", blank=True),
                ),
                (
                    "city",
                ...
                (
                    "zip",
                    models.CharField(max_length=32, verbose_name="Postal / Zip Code", blank=True),
                ),
